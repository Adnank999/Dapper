...
export function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      ...
      <Card className="mx-auto max-w-sm w-full relative backdrop-blur-xl border-white/20 shadow-2xl">
          ...
          <form action="">
            <div className="grid gap-4">
              <div className="grid gap-2">
                ...
                <NeonBorder animation-type="none" duration={0}  animationType="static"
                  ...
                  <input
                    ...
                    required
                    className="size-full rounded-lg px-4 text-sm bg-transparent focus:outline-none"
              ...
              <div className="grid gap-2">
                ...
                <NeonBorder
                  ...
                  duration={0}
                  isActive={isPasswordFocused} // Only active when focused
