    ...
    <div ref={animationContainerRef} className="relative w-full">
      ...
      >
        <div
          ...
          className={`${fk.className} text-6xl md:text-6xl lg:text-8xl`}
        >
        ...
        <div
          ref={nextTextRef}
          className={`${fk.className} absolute text-shadow-red text-9xl`}
          style={{
            opacity: 0,
          }}
        >
          <h2 className="text-[#fa1e16] !font-stranger  tracking-wider">A Fullstack Developer</h2>
