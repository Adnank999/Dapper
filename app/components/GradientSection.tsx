...
//           ease: 'power2.out',
//           stagger: 0.1, // Adds delay between each word animation
//           scrollTrigger: {
...
//           },
//           onComplete: () => {
//             // Apply spring-like effect after the initial appearance
//             gsap.to(word, {
//               opacity: 0,
//               scale: 1, // Spring-like bounce scale
//               duration: 0.6,
//               ease: 'bounce', // Elastic spring effect
//               yoyo: true, // Bounce back to normal
//             });
//           },
//         }
//       );
...
//       }}
//     >
//       <div className="popup text-[153px] font-extrabold text-center tracking-wider text-white">Build</div>
//       <div className="popup text-[220px] font-extrabold text-center tracking-wider text-[#0099fc]">Cool</div>
//       <div className="popup text-[153px] font-extrabold text-center tracking-wider text-white">Stuff</div>
//     </div>
//   );
// };
