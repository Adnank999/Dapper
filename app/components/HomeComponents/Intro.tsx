...
//       <h1 className="leading-5 text-highlight text-3xl md:text-5xl lg:text-9xl font-bold !font-my-font-bold text-center m-0 opacity-0 translate-y-12 animate-slide-up-fade">
//         Hi, I am{" "}
//         <span className=" inline-block opacity-0  animate-slide-up-fade-delay">
