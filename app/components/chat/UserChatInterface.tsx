...
const UserChatInterface: React.FC = () => {
  ...
  return (
    <div
      className="fixed bottom-6 right-6 w-96 h-[800px] rounded-2xl z-50 overflow-hidden 
             bg-[linear-gradient(var(--angle),var(--luxury-a0),var(--luxury-a10),var(--luxury-a20))] 
      ...
      >
        ...
        <div className="flex space-x-2">
          <Input
            ...
            placeholder={
              adminOnlineStatus ? "Type your message..." : "Leave a message..."
            }
            disabled={isSending}
