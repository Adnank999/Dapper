    ...
    .\`  :  :  ,  .+s$$$s+.            .+s$$$s+.  .* ;  ;  ',
      ...
      _.-*' \`.                               :   :     |   :    :
        ...
        >
          ...
          <dt>Bio</dt>
          <dd>
            3 years experience - HTML, CSS, JavaScript,Php. Passion for
            creativity in the digital space.Problem solver.
            Hiker,Photographer,culinary enthusiast. Constantly seeking new
