...
const getLevelColor = (level: number): string => {
  ...
  switch (level) {
    ...
    case 1: return 'bg-red-200 dark:bg-green-900'; // Low
    case 2: return 'bg-red-400 dark:bg-green-700'; // Medium
    case 3: return 'bg-red-600 dark:bg-green-500'; // High
    case 4: return 'bg-red-800 dark:bg-green-300'; // Very high
    default: return 'bg-red-100 dark:bg-gray-800';
  }
};
